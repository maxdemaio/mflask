...
## Static files
For Bootstrap's libraries and the jQuery dataTables plug-in I use their CDNs. For the rest of my static files I md5 hash them, dynamically render them with [Flask-Static-Digest](https://github.com/nickjj/flask-static-digest), and use Amazon S3 for storage.